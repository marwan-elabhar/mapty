...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === 'running') {
            ...
            if (!isValidInputs(distance, duration, cadence) || !isPositiveInputs(distance, duration, cadence)) {
        ...
        if (type === 'cycling') {
            ...
            if (!isValidInputs(distance, duration, elevation) || !isPositiveInputs(distance, duration)) {
                return alert("Please enter a positive number")
            }
